...
<Tabs>
    <TabItem label="API [Production]">
        https://api.egov.go.th/ws/auth/validate?ConsumerSecret=[Secret]&AgentID=[เลขประจำตัวประชาชน]
    </TabItem>
    <TabItem label="API [Test]">
...
* ข้อมูลบุคคล IKNO [คลิกเพื่อเปิดดูเอกสาร](https://raw.githubusercontent.com/DGA-Thailand/kb/main/src/assets/files/GovAPI_PersonAPI_AdminManual_22112018.pdf) (เปลี่ยนไปใช้งานแบบ Linkage Center แทน)
